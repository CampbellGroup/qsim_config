class Config(object):
    ...
    scripts = [
        ...
        (path + "411_linescan.411_linescan", "Linescan411"),
        ...
        (
            path + "Microwave_Rabi_Flopping.microwave_rabi_flopping",
        ...
        (
            path + "Microwave_Ramsey_Light_Shift.microwave_ramsey_light_shift",
            "MicrowaveRamseyLightShift",
        ),
        (
            path + "Microwave_Ramsey_Experiment.microwave_ramsey_experiment",
        ...
        (
            path + "wavemeter_linescan_badwm.wavemeter_linescan_badwm",
            "WavemeterLinescanBadWM",
        ),
        (
            path + "Metastable_Microwave_Linescan.metastable_microwave_linescan",
            "MetastableMicrowaveLineScan",
        ),
        (
            path
            + "Metastable_Microwave_Rabi_Flopping.metastable_microwave_rabi_flopping",
        ...
        (
            path
            + "Metastable_Microwave_Ramsey_Experiment.metastable_microwave_ramsey_experiment",
            "MetastableMicrowaveRamseyExperiment",
        ),
        (
            path
            + "Metastable_Microwave_Ramsey_Light_Shift.metastable_microwave_ramsey_light_shift",
            "MetastableMicrowaveRamseyLightShift",
        ),
        (
            path
            + "Metastable_Microwave_Ramsey_Light_Shift_One_Time.metastable_microwave_ramsey_light_shift_one_time",
            "OneTimeMetastableMicrowaveRamseyLightShift",
        ),
